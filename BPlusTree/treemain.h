...
int search_keys[NUM_SEARCH_KEYS];
...
tree_node *addToParent(tree_node *tree, int key, tree_node *left_node, tree_node *right_node) {
    ...
    tree_node *parent = left_node->parent;
    int index = 0;
